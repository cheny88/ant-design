...
import type {DisabledTimes, PanelMode, PickerMode, RangeValue, EventValue} from 'rc-picker/lib/interface';
...
import getDataOrAriaProps, {toArray, getValue, updateValues} from 'rc-picker/lib/utils/miscUtil';
import {getDefaultFormat, getInputSize, elementsContains} from 'rc-picker/lib/utils/uiUtil';
...
type OmitPickerProps<Props> = Omit<Props,
  | 'value'
  | 'defaultValue'
  | 'defaultPickerValue'
  | 'placeholder'
